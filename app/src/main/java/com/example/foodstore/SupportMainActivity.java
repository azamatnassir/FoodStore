...
public class SupportMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText1 = findViewById(R.id.support_main_name);
        editText2 = findViewById(R.id.support_main_title);
        editText3 = findViewById(R.id.support_main_description);

        Button button = findViewById(R.id.support_main_btn);
